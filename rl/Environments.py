...
class Surface_Code_Environment_Multi_Decoding_Cycles():
    ...
    def step(self, action):
        ...
        current_true_syndrome_tensor = np.reshape(self.current_true_syndrome, (1, self.d+1, self.d+1)) # JW
        ...
        decoder_label = self.static_decoder.predict(np.array([current_true_syndrome_tensor]), batch_size=1, verbose=0) # JW 
